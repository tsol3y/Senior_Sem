...
class PortfolioEnv(gym.Env):
    ...
    def __init__(self,
        ...
        # self.action_space = gym.spaces.Box(0.0, 1.0, shape=nb_assets + 1) # ORIGINALLY
        self.action_space = gym.spaces.Box(0.0, 1.0, shape=np.array([nb_assets + 1]))
    ...
    def _reset(self):
        ...
        self.infos = []
        action = self.sim.w0
        # observation, reward, done, info = self.step(action) # ORIGINALLY
